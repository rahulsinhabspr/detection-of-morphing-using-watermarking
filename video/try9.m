...
originalvideo='newgrayscalemyencrytedbalam1.avi';
...
numframeswritten1=0;
%storing enc value
storingenc=zeros(1,40);
%for loop to convert and store gray scale image
for t1=1:40
currentframe=read(inputmov1,t1);
                 ...
                 %program
                  if (isequal(a1,b1) && isequal(a2,b2) && isequal(a3,b3) && isequal(a4,b4) && isequal(a5,b5))
                        ...
                        %checking image is morphed or not
                         ...
                         if r==1
                             progressindication=sprintf('%4d frame  of %d is not morphed',t1,numberofframes1);
                             disp(progressindication);
                         else
                             progressindication=sprintf('%4d frame  of %d is  morphed',t1,numberofframes1);
                             disp(progressindication);
                         end
